    ...
    <>
      {!isOpen && (
        <motion.div
          ...
          className="max-w-200 w-full gap-5 h-full min-h-[400px] md:bg-[#4b4b4b] py-10 px-4 min-w-0 rounded-xl"
        >
          ...
          <div className="w-full h-full flex justify-center items-center gap-5 ">
            <div className="h-8 custom-prev text-5xl select-none cursor-pointer md:mx-2">
              {"<"}
            </div>
            <Swiper
              spaceBetween={-40}
            ...
            <div className=" h-8 custom-next text-5xl select-none cursor-pointer md:mx-2">
              {">"}
            </div>
          </div>
        </motion.div>
      ...
      {isOpen && (
        <div className="flex flex-col max-w-200 w-full gap-5 h-full md:bg-[#4b4b4b] min-h-[400px] py-5 px-4 min-w-0 rounded-xl ">
          <div className="flex justify-between items-end mb-2 w-full px-3 h-9">
            <h3 className="lg:text-3xl text-lg text-white">FRONTEND</h3>
