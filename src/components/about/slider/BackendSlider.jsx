      ...
      {!isOpen && (
        ...
        >
          ...
          <div className="w-full h-full flex justify-center items-center gap-5 ">
            <div className="h-8 custom-prev-back text-5xl select-none cursor-pointer md:mx-2">
              {"<"}
            </div>
            <Swiper
              spaceBetween={-40}
            ...
            <div className=" h-8 custom-next-back text-5xl select-none cursor-pointer md:mx-2">
              {">"}
            </div>
          </div>
        </motion.div>
